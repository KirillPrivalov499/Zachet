...
public class ListMessages2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String recipientUid = arguments.get("recipientUid").toString();
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(textField.getText().toString().isEmpty()){
                    ...
                    textField.setText("");
                    FirebaseDatabase.getInstance().getReference().child("Notifications").child(recipientUid).child("new_messages").push().setValue(new Message(FirebaseAuth.getInstance().getCurrentUser().getDisplayName(),FirebaseAuth.getInstance().getUid(),
                            textField.getText().toString()));
                }
            }
